...
function get_gramtab_map($language) {
    ...
    $gramtab = new phpMorphy_Aot_GramTab_File(
        $gramtab_file,
        phpMorphy_Aot_Mwz_File::getEncodingForLang($language),
        new phpMorphy_Aot_GramTab_GramInfoFactory(phpMorphy_Aot_GramTab_GramInfoHelperAbstract::createByLanguage($language))
    );
